 ...
 */}
                    ...
                    <div className="changing_btns_frm3">



                        <input type="submit" onClick={() => { setpage((currPage) => currPage - 1) }} value="Previous" className='Submit_form_button_frm3 prev' />

                        <input type="submit" onClick={() => { setpage((currPage) => currPage + 1) }} value="Continue" className='Submit_form_button_frm3 continue' />
